# -*- encoding: utf-8 -*-
# stub: devise-two-factor 6.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<railties>.freeze, [">= 7.2".freeze, "< 8.2".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 7.2".freeze, "< 8.2".freeze])
